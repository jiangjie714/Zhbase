...
public class HbaseTest {
	 ...
	 public static void createTable(Configuration configuration,String tableName){
	  ...
	  // RecoverableZooKeeper z = new RecoverableZooKeeper();
	...
	public static void main(String[] args) {
		...
		configuration.set("hbase.zookeeper.quorum", "hadoop-matser.com,hadoop-s2.com,hadoop-s1.com,hadoop-data.com");
		 configuration.set("hbase.master", "hadoop-s1.com:600000");
